...
# 2026 calendar — Bahrain (originally R4) and Jeddah (originally R5) cancelled mid-season
# due to Middle East conflict. Subsequent rounds renumbered to match F1 Fantasy gameday IDs.
